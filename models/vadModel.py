...
class VAD():
  def __init__(self, model, deltaPVAD=0.4):
    ...
    self.b0 = self.Kp*(1+self.N) + self.Ki*(1+self.N) + self.Kd*self.N
    self.b1 = -(self.Kp*(2+self.N) + self.Ki + 2*self.Kd*self.N)
  ...
  def refereceChange(self, index, mPao_ref=110):
    if index >= 49999 and index <= 150000:
        self.mPao_ref = mPao_ref
    elif index > 150000 and index <= 230000:
        self.mPao_ref = 90
    elif index > 230000: 
        self.mPao_ref = 100
